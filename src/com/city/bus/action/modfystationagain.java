...
/**
 * Servlet implementation class modfystationagain
 */
@WebServlet("/bus/modfystationagain.do")
public class modfystationagain extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public modfystationagain() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			iStation.modify(stationId,station, startTime, endTime);
