...
/**
 * Servlet implementation class modfypower
 */
@WebServlet("/bus/modfypower.do")
public class modfypower extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("modfypower.jsp");
