...
<body>
	...
	<div class="bar" >
      <p style="font-family:'华文新魏'; font-size: x-large;"> 修改权限 </p>
         <form method="post" action="modfypower.do">
			...
			<c:forEach var="pi" items="${powerlist}">
					...
					color:#fff" href="remodfypower.do?username=${pi.username}
					&password=${pi.password}&power=${pi.power}">修改</a>
					</td>
					</tr>
					</c:forEach>		
